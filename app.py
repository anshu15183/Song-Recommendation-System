...
if st.button('Recommend',):
    ...
    for i in range(1, 6):
        ...
        <div style="position: relative;">
                ...
                <button class="vnCew8qzJq3cVGlYFXRI" style="position: absolute; bottom: 10px; right: 10px; width: 50px; height: 50px;"><svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" class="Svg-sc-ytk21e-0 dYnaPI"><path d="M3 1.713a.7.7 0 0 1 1.05-.607l10.89 6.288a.7.7 0 0 1 0 1.212L4.05 14.894A.7.7 0 0 1 3 14.288V1.713z"></path></svg></button>
            </a>
